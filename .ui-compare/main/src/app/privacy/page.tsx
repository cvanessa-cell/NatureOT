...
export default function PrivacyPage() {
  return (
    <article className="mx-auto max-w-3xl space-y-4 px-4 py-14 text-bark/90">
      ...
      <h2 className="mt-8 font-display text-xl text-forest">What we collect</h2>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">What we do not collect in this marketing funnel</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">How we use information</h2>
      <ul className="list-inside list-disc space-y-2">
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Consent records</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Unsubscribe</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Sharing</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Retention</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Contact</h2>
      <p>
