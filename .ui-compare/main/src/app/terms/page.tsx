...
export default function TermsPage() {
  return (
    <article className="mx-auto max-w-3xl space-y-4 px-4 py-14 text-bark/90">
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Educational information only</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">No guarantees</h2>
      <p>
        We do not guarantee any particular outcome from programs, groups, or
        outdoor activities. Individual results vary.
      </p>
      <h2 className="mt-8 font-display text-xl text-forest">Not an emergency service</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Scheduling and communications</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Acceptable use</h2>
      <p>
        Do not misuse the site, attempt unauthorized access, or use automated
        means to scrape or overload our systems.
      </p>
      <h2 className="mt-8 font-display text-xl text-forest">Limitation of liability</h2>
      <p>
      ...
      <h2 className="mt-8 font-display text-xl text-forest">Updates</h2>
      <p>
