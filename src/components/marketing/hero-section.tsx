...
export function HeroLead({ data }: { data?: HeroProps | null }) {
  const headline =
  ...
  return (
    <div className="max-w-xl px-4 pt-10 sm:pt-14 lg:px-6 lg:pt-24">
...
export function HeroSection({ data }: { data?: HeroProps | null }) {
  ...
  return (
    <section className="relative overflow-hidden bg-cream">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 sm:pb-20 lg:px-6 lg:pb-24 xl:gap-20">
        <div className="relative lg:-mr-4 xl:-mr-8 lg:mx-auto lg:max-w-xl">
          <svg
