...
export function getEnv(): Env {
  return envSchema.parse({
    ...
    NEXT_PUBLIC_BOOKING_EMBED_URL: process.env.NEXT_PUBLIC_BOOKING_EMBED_URL,
    ...
    ZAPIER_NEW_LEAD_WEBHOOK_URL: process.env.ZAPIER_NEW_LEAD_WEBHOOK_URL,
    ZAPIER_WAITLIST_WEBHOOK_URL: process.env.ZAPIER_WAITLIST_WEBHOOK_URL,
    ZAPIER_WORKSHOP_WEBHOOK_URL: process.env.ZAPIER_WORKSHOP_WEBHOOK_URL,
    ZAPIER_BOOKING_WEBHOOK_URL: process.env.ZAPIER_BOOKING_WEBHOOK_URL,
    ZAPIER_FEEDBACK_WEBHOOK_URL: process.env.ZAPIER_FEEDBACK_WEBHOOK_URL,
    ZAPIER_UNSUBSCRIBE_WEBHOOK_URL: process.env.ZAPIER_UNSUBSCRIBE_WEBHOOK_URL,
    ZAPIER_ERROR_WEBHOOK_URL: process.env.ZAPIER_ERROR_WEBHOOK_URL,
    ZAPIER_REFERRAL_WEBHOOK_URL: process.env.ZAPIER_REFERRAL_WEBHOOK_URL,
    ZAPIER_CONTENT_WEBHOOK_URL: process.env.ZAPIER_CONTENT_WEBHOOK_URL,
    ZAPIER_SEO_WEBHOOK_URL: process.env.ZAPIER_SEO_WEBHOOK_URL,
    NEXT_PUBLIC_BOOKING_URL:
      process.env.NEXT_PUBLIC_BOOKING_URL ??
      process.env.NEXT_PUBLIC_BOOKING_EMBED_URL,
    PARENT_GUIDE_ASSET_URL: process.env.PARENT_GUIDE_ASSET_URL,
