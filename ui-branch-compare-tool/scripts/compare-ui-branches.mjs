...
async function main() {
  ...
  try {
    ...
    const routes = parseRoutes(args.routes || "/,/events,/calendar,/admin,/admin/events/web-discovery");
...
async function ensureWorktree({ repoRoot, targetPath, label, commitish, rl }) {
...
function startDevServer(worktreePath, label, port) {
